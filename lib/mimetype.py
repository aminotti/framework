...
MimeType.add('application', 'ogg', ['ogx'], True)
MimeType.add('application', 'onenote', ['one', 'onetoc2', 'onetmp', 'onepkg'])
MimeType.add('application', 'pdf', ['pdf'], flag='document')
MimeType.add('application', 'pgp-encrypted', ['pgp'], True)
MimeType.add('application', 'pgp-keys', ['key'], True)
MimeType.add('application', 'pgp-signature', ['sig'], True)
...
MimeType.add('application', 'vnd.oasis.opendocument.chart', ['odc'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.database', ['odb'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.formula', ['odf'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.graphics', ['odg'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.graphics-template', True, ['otg'], flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.image', ['odi'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.presentation', ['odp'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.presentation-template', ['otp'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.spreadsheet', ['ods'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.spreadsheet-template', ['ots'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.text', ['odt'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.text-master', ['odm'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.text-template', ['ott'], True, flag='document')
MimeType.add('application', 'vnd.oasis.opendocument.text-web', ['oth'], True, flag='document')
...
MimeType.add('application', 'x-bittorrent', ['torrent'], True)
MimeType.add('application', 'x-cdf', ['cdf', 'cda'])
MimeType.add('application', 'x-cpio', ['cpio'], True)
MimeType.add('application', 'x-debian-package', ['deb', 'udeb'], True)
...
MimeType.add('application', 'x-latex', ['latex'], True)
MimeType.add('application', 'x-mpegURL', ['m3u8'])
MimeType.add('application', 'x-redhat-package-manager', ['rpm'], True)
...
MimeType.add('application', 'x-x509-ca-cert', ['crt'], True)
